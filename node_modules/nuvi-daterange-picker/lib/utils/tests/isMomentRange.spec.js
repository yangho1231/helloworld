...
describe('isMomentRange', function () {
  ...
  it('returns false is the end value is not a moment value', function () {
    expect((0, _isMomentRange2.default)({ start: (0, _momentRange2.default)(), end: 'a' })).toBe(false);
  });

  it('return true otherwise', function () {
    expect((0, _isMomentRange2.default)({ start: (0, _momentRange2.default)(), end: (0, _momentRange2.default)() })).toBe(true);
  });
});