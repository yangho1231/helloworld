...
describe('The DateRangePicker component', function () {
  ...
  beforeEach(function () {
    ...
    this.useDocumentRendererWithComplexStates = function () {
      ...
      _this.nonSelectableRange = _momentRange2.default.range((0, _momentRange2.default)(new Date(2002, 1, 15)), (0, _momentRange2.default)(new Date(2003, 1, 15)));
      var dateStates = [{
        state: 'enquire',
        range: _momentRange2.default.range((0, _momentRange2.default)(new Date(2000, 1, 15)), (0, _momentRange2.default)(new Date(2001, 1, 15)))
      }, {
        state: 'unavailable',
  ...
  describe('contains CalendarMonth components', function () {
    ...
    describe('for each component the value', function () {
      ...
      describe('when it is a moment', function () {
        ...
        it('is set to null if it is not included in the corresponding month', function () {
          var value = (0, _momentRange2.default)('2003 01 01', 'YYYY MM DD');
          this.useShallowRenderer({
            initialYear: 2000,
            initialMonth: 6,
            value: value,
        ...
        it('otherwise it uses props.value', function () {
          var value = (0, _momentRange2.default)('2000 06 05', 'YYYY MM DD');
          this.useShallowRenderer({
            initialYear: 2000,
            initialMonth: 5,
            value: value,
      ...
      describe('when it is a moment range', function () {
        ...
        it('is set to null if it is not overlapping the corresponding month', function () {
          var value = _momentRange2.default.range((0, _momentRange2.default)('2003 01 01', 'YYYY MM DD'), (0, _momentRange2.default)('2004 01 01', 'YYYY MM DD'));
          this.useShallowRenderer({
            initialYear: 2000,
            initialMonth: 6,
            value: value,
        ...
        it('otherwise it uses props.value', function () {
          var value = _momentRange2.default.range((0, _momentRange2.default)('2000 04 01', 'YYYY MM DD'), (0, _momentRange2.default)('2000 09 01', 'YYYY MM DD'));
          this.useShallowRenderer({
            initialYear: 2000,
            initialMonth: 6,
            value: value,
    ...
    describe('for each component the highlighted date', function () {
      ...
      it('is set to null if the current month does not include the date', function () {
        var highlightedDate = (0, _momentRange2.default)('2003 01 01', 'YYYY MM DD');
        this.useDocumentRenderer({
          initialYear: 2000,
          initialMonth: 6
        });
      ...
      it('is set to props.highlightedDate otherwise', function () {
        var highlightedDate = (0, _momentRange2.default)('2000 07 05', 'YYYY MM DD');
        this.useDocumentRenderer({
          initialYear: 2000,
          initialMonth: 6
        });
    ...
    describe('for each component the highlighted range', function () {
      ...
      it('is set to null if the current month does not include the date range', function () {
        var highlightedRange = _momentRange2.default.range((0, _momentRange2.default)('2003 01 01', 'YYYY MM DD'), (0, _momentRange2.default)('2004 01 01', 'YYYY MM DD'));
        this.useDocumentRenderer({
          initialYear: 2000,
          initialMonth: 6
        });
      ...
      it('defaults to props.highlightedRange', function () {
        var highlightedRange = _momentRange2.default.range((0, _momentRange2.default)('1999 01 01', 'YYYY MM DD'), (0, _momentRange2.default)('2004 01 01', 'YYYY MM DD'));
        this.useDocumentRenderer({
          initialYear: 2000,
          initialMonth: 6
        });
    ...
    describe('each component is provided with a number of event handlers', function () {
      ...
      it('onSelectDate calls #onSelectDate', function () {
        this.useDocumentRenderer();
        var calendarMonthComponent = _reactAddonsTestUtils2.default.scryRenderedComponentsWithType(this.renderedComponent, _CalendarMonth2.default)[0];
        calendarMonthComponent.props.onSelectDate((0, _momentRange2.default)());
      ...
      it('onHighlightDate calls #onHighlightDate', function () {
        this.useDocumentRenderer();
        var calendarMonthComponent = _reactAddonsTestUtils2.default.scryRenderedComponentsWithType(this.renderedComponent, _CalendarMonth2.default)[0];
        calendarMonthComponent.props.onHighlightDate((0, _momentRange2.default)());
      ...
      it('onUnHighlightDate calls #onUnHighlightDate', function () {
        ...
        var calendarMonthComponent = _reactAddonsTestUtils2.default.scryRenderedComponentsWithType(this.renderedComponent, _CalendarMonth2.default)[0];
        calendarMonthComponent.props.onHighlightDate((0, _momentRange2.default)());
        calendarMonthComponent.props.onUnHighlightDate((0, _momentRange2.default)());
  ...
  describe('defines a number of actions', function () {
        ...
        describe('if state.selectedStartDate is undefined', function () {
          ...
          describe('if the date is not disabled and is selectable', function () {
            ...
            it('if props.singleDateRange is true, it calls #highlightRange', function () {
              ...
              expect((0, _areMomentRangesEqual2.default)(range, _momentRange2.default.range(this.date, this.date))).toBe(true);
            });
          });
        });
      });
      ...
      describe('if props.selectionType is a range', function () {
        ...
        describe('if state.selectedStartDate is defined', function () {
          ...
          it('calls #highlightRange', function () {
            var range = _momentRange2.default.range();
            spyOn(this.renderedComponent, 'sanitizeRange').and.returnValue(range);
            spyOn(this.renderedComponent, 'highlightRange');
            this.renderedComponent.setState({
              selectedStartDate: (0, _momentRange2.default)()
            });
            this.renderedComponent.onHighlightDate((0, _momentRange2.default)());
    ...
    describe('#onUnHighlightDate', function () {
      ...
      it('updates the highlightedDate state to null', function () {
        ...
        this.renderedComponent.setState({
          highlightedDate: (0, _momentRange2.default)()
        });
  ...
  describe('#componentWillReceiveProps', function () {
    ...
    describe('updating the value', function () {
      describe('when the selection type is single', function () {
        ...
        it('updates component year and month if value is updated with a single date', function () {
          var newValue = (0, _momentRange2.default)(new Date('1985/10/26'));
    ...
    describe('when the selection type is range', function () {
      ...
      it('updates component year and month if value is a range', function () {
        var newValue = _momentRange2.default.range((0, _momentRange2.default)(new Date('1985/10/26')), (0, _momentRange2.default)(new Date('2015/10/21')));
        spyOn(this.renderedComponent, 'getDateStates').and.returnValue([]);
  ...
  describe('#sanitizeRange', function () {
    ...
    describe('if forwards is true', function () {
      ...
      it('and if the provided range intersects with the non selectable ranges it returns a smaller range', function () {
        var range = this.renderedComponent.sanitizeRange(_momentRange2.default.range((0, _momentRange2.default)(new Date(2001, 1, 15)), (0, _momentRange2.default)(new Date(2003, 1, 15))), true);
        expect((0, _areMomentRangesEqual2.default)(range, _momentRange2.default.range((0, _momentRange2.default)(new Date(2001, 1, 15)), (0, _momentRange2.default)(new Date(2002, 1, 15))))).toBe(true);
      });

      it('and if the provided range starts before the enabled range it returns a smaller range', function () {
        var range = this.renderedComponent.sanitizeRange(_momentRange2.default.range((0, _momentRange2.default)(new Date(2001, 1, 15)), (0, _momentRange2.default)(new Date(2002, 1, 1))), true);
        expect((0, _areMomentRangesEqual2.default)(range, _momentRange2.default.range((0, _momentRange2.default)(new Date(2001, 1, 15)), (0, _momentRange2.default)(new Date(2001, 1, 20))))).toBe(true);
      });

      it('and if the provided range finishes after the enabled range it returns a smaller range', function () {
        var range = this.renderedComponent.sanitizeRange(_momentRange2.default.range((0, _momentRange2.default)(new Date(2006, 1, 15)), (0, _momentRange2.default)(new Date(2007, 1, 1))), true);
        expect((0, _areMomentRangesEqual2.default)(range, _momentRange2.default.range((0, _momentRange2.default)(new Date(2006, 1, 15)), (0, _momentRange2.default)(new Date(2001, 1, 20))))).toBe(true);
      });

      it('otherwise it returns the full range', function () {
        var range = this.renderedComponent.sanitizeRange(_momentRange2.default.range((0, _momentRange2.default)(new Date(2001, 1, 15)), (0, _momentRange2.default)(new Date(2001, 1, 17))), true);
        expect((0, _areMomentRangesEqual2.default)(range, _momentRange2.default.range((0, _momentRange2.default)(new Date(2001, 1, 15)), (0, _momentRange2.default)(new Date(2001, 1, 17))))).toBe(true);
      });
    });

    describe('otherwise', function () {
      it('and if the provided range intersects with the non selectable ranges it returns a smaller range', function () {
        var range = this.renderedComponent.sanitizeRange(_momentRange2.default.range((0, _momentRange2.default)(new Date(2001, 1, 15)), (0, _momentRange2.default)(new Date(2005, 1, 15))), false);
        expect((0, _areMomentRangesEqual2.default)(range, _momentRange2.default.range((0, _momentRange2.default)(new Date(2003, 1, 15)), (0, _momentRange2.default)(new Date(2005, 1, 15))))).toBe(true);
      });

      it('and if the provided range starts before the enabled range it returns a smaller range', function () {
        var range = this.renderedComponent.sanitizeRange(_momentRange2.default.range((0, _momentRange2.default)(new Date(2001, 1, 15)), (0, _momentRange2.default)(new Date(2002, 1, 1))), false);
        expect((0, _areMomentRangesEqual2.default)(range, _momentRange2.default.range((0, _momentRange2.default)(new Date(2001, 1, 15)), (0, _momentRange2.default)(new Date(2001, 1, 20))))).toBe(true);
      });

      it('and if the provided range finishes after the enabled range it returns a smaller range', function () {
        var range = this.renderedComponent.sanitizeRange(_momentRange2.default.range((0, _momentRange2.default)(new Date(2006, 1, 15)), (0, _momentRange2.default)(new Date(2007, 1, 1))), false);
        expect((0, _areMomentRangesEqual2.default)(range, _momentRange2.default.range((0, _momentRange2.default)(new Date(2006, 1, 15)), (0, _momentRange2.default)(new Date(2001, 1, 20))))).toBe(true);
      });

      it('otherwise it returns the full range', function () {
        var range = this.renderedComponent.sanitizeRange(_momentRange2.default.range((0, _momentRange2.default)(new Date(2001, 1, 15)), (0, _momentRange2.default)(new Date(2001, 1, 17))), false);
        expect((0, _areMomentRangesEqual2.default)(range, _momentRange2.default.range((0, _momentRange2.default)(new Date(2001, 1, 15)), (0, _momentRange2.default)(new Date(2001, 1, 17))))).toBe(true);
      });
    });
  });
  ...
  describe('#statesForDate', function () {
    ...
    it('returns the expected state for the provided date', function () {
      var list = this.renderedComponent.statesForDate((0, _momentRange2.default)(new Date(2003, 1, 1)));
      expect(list).toEqual(jasmine.any(_immutable2.default.List));
  ...
  describe('#statesForRange', function () {
    ...
    it('returns the expected value if a one-day range is provided', function () {
      var range = _momentRange2.default.range((0, _momentRange2.default)(new Date(2003, 1, 1)), (0, _momentRange2.default)(new Date(2003, 1, 1)));
    ...
    it('returns the expected value if a multi-day range is provided', function () {
      var range = _momentRange2.default.range((0, _momentRange2.default)(new Date(2003, 1, 14)), (0, _momentRange2.default)(new Date(2003, 1, 16)));
      var list = this.renderedComponent.statesForRange(range);
      expect(list).toEqual(jasmine.any(_immutable2.default.List));
  ...
  describe('#completeSelection', function () {
    ...
    describe('if state.highlightedDate is defined', function () {
      ...
      beforeEach(function () {
        this.highlightedDate = (0, _momentRange2.default)();
        this.renderedComponent.setState({
    ...
    describe('if state.highlightedRange is defined', function () {
      ...
      describe('and its start and end are two different days', function () {
        ...
        beforeEach(function () {
          ...
          this.highlightedRange = _momentRange2.default.range((0, _momentRange2.default)(new Date(2005, 1, 1)), (0, _momentRange2.default)(new Date(2006, 1, 1)));
          this.highlightedDate = (0, _momentRange2.default)();
          this.renderedComponent.setState({
      ...
      describe('and its start and end are the same day and props.singleDateRange is true', function () {
        ...
        beforeEach(function () {
          ...
          this.highlightedRange = _momentRange2.default.range((0, _momentRange2.default)(new Date(2005, 1, 1)), (0, _momentRange2.default)(new Date(2005, 1, 1)));
          this.highlightedDate = (0, _momentRange2.default)();
          this.renderedComponent.setState({
            highlightedRange: this.highlightedRange,
            selectedStartDate: this.selectedStartDate,
