...
function DateRange(start, end) {
  ...
  if (arguments.length === 1 || end === undefined) {
    if ((typeof start === 'undefined' ? 'undefined' : (0, _typeof3.default)(start)) === 'object' && start.length === 2) {
      s = start[0];
      e = start[1];
...
DateRange.prototype.clone = function () {
  return (0, _moment2.default)().range(this.start, this.end);
};
...
DateRange.prototype.add = function (other) {
  if (this.overlaps(other)) {
    return new DateRange(_moment2.default.min(this.start, other.start), _moment2.default.max(this.end, other.end));
  }
...
function _byString(interval, hollaback, exclusive) {
  var current = (0, _moment2.default)(this.start);
...
function _byRange(interval, hollaback, exclusive) {
  ...
  for (var i = 0; i <= l; i++) {
    hollaback.call(this, (0, _moment2.default)(this.start.valueOf() + interval.valueOf() * i));
  }
}
 ...
 * @return {!DateRange}
 */
_moment2.default.range = function (start, end) {
  if (start in INTERVALS) {
    return new DateRange((0, _moment2.default)(this).startOf(start), (0, _moment2.default)(this).endOf(start));
  } else {
 ...
 * @const
 */
_moment2.default.range.constructor = DateRange;

/**
 * @deprecated
 */
_moment2.default.fn.range = _moment2.default.range;
 ...
 * @return {!boolean}
 */
_moment2.default.fn.within = function (range) {
